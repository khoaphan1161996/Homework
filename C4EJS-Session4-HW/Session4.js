...
//Câu 2: Learn about destructuring object in the following tutorials:
// Cách1
// const task = {
...
// Câu 3 Here is the actual data from a job search site, copy all of the data, assign it to a variable
...
// 3.1. What is the data type of the outermost layer (Number, String,
//    Object, Array or else)?
// Kiểu dữ liệu lớp ngoài cùng là Object

// 3.2. The hits property is where the job results are stored, is it a Number,
// String, Array, Object or something else?
// hits property là Array

// 3.3. In each hit of hits, how to find the job’s title, locations, salary, benefits,
...
// // locations
// for( let i = 0 ; i<hits.length; i++){
//     console.log(hits[i].locations[0])
// }
// // salary 
// for( let i = 0 ; i<hits.length; i++){
...
// }
// let [hits1,hits2,hits3,hits4,hits5,hits6] = hits
// for( let i = 0 ; i<hits1.skills.length; i++){
//     console.log(hits1.skills[i])
// }
// for( let i = 0 ; i<hits2.skills.length; i++){
//     console.log(hits2.skills[i])
// }
// for( let i = 0 ; i<hits3.skills.length; i++){
//     console.log(hits3.skills[i])
// }
// for( let i = 0 ; i<hits4.skills.length; i++){
//     console.log(hits4.skills[i])
// }
// // requirements
// for( let i = 0 ; i<hits.length; i++){
...
// Câu 4: Initialize an object to represent a dictionary, with properties as keyword and values as
// explanation, the initial values are from this table
// let tudien = {
...
// }
// if(a==0){
//     let fix =prompt("we could not find your word: "+n+", leave your explanation")
//     tudien[n] = fix
//     alert("Done")
// }
// alert("Hi there, this is dev dictionary")
// n = prompt("Enter a keyword")
// }

//Câu 5: Initialize a variable named products, containing an array of products, each product has a name, price, brand, category, and color
// let products = [
//     {
...
// }
// let vitri = prompt("Enter products position:")

//C1
// for(let x in products[vitri-1] ) {
//     console.log(`${x}: ${products[vitri-1][x]}`)
// }
//C2
// console.log("Name: "+products[vitri-1].Name)
// console.log("Brand: "+products[vitri-1].Brand)
// console.log("Price: "+products[vitri-1].Price)
// console.log("Color: "+products[vitri-1].Color)
// console.log("Category: "+products[vitri-1].Category)
...
// }
// if(x==0){
//     console.log("khong tim thay, nhap lai")
// }
// }
...
//             if(prov == products[i].Providers[j]){
...
//Câu 6. Write a script to store and process the learning tasks to become a front-end developer
//6.1 Print it out
// let store = [
//     {
//         Name: "HTML",
...
//     alert(`#${i+1}. ${store[i].Name}\n    Complete: ${store[i].Complete}`)
// }
// // 6.2 New
// while(true){
// let chao = prompt("Enter your command(New, Delete, Update, Complete)").toLocaleLowerCase()
// if(chao == "new"){
...
// store[(vitri-1)].Name = newtitle
// for(let i=0; i<store.length;i++){
//     alert(`#${i+1}. ${store[i].Name}\n    Complete: ${store[i].Complete}`)
// }
// }
// // 6.4 Complete
// else if(chao == "complete"){
// let vitriC = prompt("Enter position")
// store[(vitriC-1)].Complete = true
// for(let i=0; i<store.length;i++){
//     alert(`#${i+1}. ${store[i].Name}\n    Complete: ${store[i].Complete}`)
// }
// }
// // 6.5 Delete
// else if(chao == "delete"){
// let vitriD = prompt("Enter position")
// store.splice(vitriD-1, 1)
// for(let i=0; i<store.length;i++){
//     alert(`#${i+1}. ${store[i].Name}\n    Complete: ${store[i].Complete}`)
// }
// }
// else chao = prompt("Enter your command(New, Delete, Update, Complete)").toLocaleLowerCase()
// }

//15. (Optional) Get jobs data from this link, copy the whole content and assign it a variable or
// a constant named jobData
// let jobData={
    //     hits: [
    //         {
    //             benefits: [
    ...
    // console.log("Frist job title:")
    // console.log(hits1.jobTitle)
    // 15.4. Get the benefits of the first job hit
    // console.log(hits1.benefits)
    // 15.5. Log out first job hit benefit values
    // console.log("Frist job hit benefit:")
    // for(let i = 0 ; i<hits1.benefits.length; i ++){
    // console.log("- "+ hits1.benefits[i].benefitValue)
    // }
    ...
    //     for(let j =0; j<hits[i].benefits.length; j++){
    //         console.log("- "+hits[i].benefits[j].benefitValue)
    //     }
    // }
    ...
    //     }
    //     console.log("Skills:")
    //     for(let j =0; j<hits[i].skills.length; j++){
    //         console.log("- "+hits[i].skills[j])
    //     }
    // }

// Câu 16: (Optional) There are at least two ways to delete a property-value pair from an object, the
// first one is the one you learned in class, to use delete keyword (which you already
// learned).. The second one is to create a new object without the property-value pair and
// just use the new object from then.
